package de.htw.ai.Wiki_Importer.utils.database

import de.htw.ai.Wiki_Importer.utils.database.InverseIndexTable.NGram
import de.htw.ai.Wiki_Importer.utils.database.InverseIndexTable.DocId
import de.htw.ai.Wiki_Importer.utils.database.InverseIndexTable.Occurences
